...
type GreeterClient interface {
	...
	GetIssuedTicketsByAgentCode(ctx context.Context, in *GetIssuedUserTicketsByAgentCodeRequest, opts ...grpc.CallOption) (*GetIssuedUserTicketsByAgentCodeResponse, error)
...
func (c *greeterClient) GetIssuedTicketsByAgentCode(ctx context.Context, in *GetIssuedUserTicketsByAgentCodeRequest, opts ...grpc.CallOption) (*GetIssuedUserTicketsByAgentCodeResponse, error) {
	out := new(GetIssuedUserTicketsByAgentCodeResponse)
	err := c.cc.Invoke(ctx, "/games.Greeter/GetIssuedTicketsByAgentCode", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreeterServer interface {
	...
	GetIssuedTicketsByAgentCode(context.Context, *GetIssuedUserTicketsByAgentCodeRequest) (*GetIssuedUserTicketsByAgentCodeResponse, error)
...
func (UnimplementedGreeterServer) GetIssuedTicketsByAgentCode(context.Context, *GetIssuedUserTicketsByAgentCodeRequest) (*GetIssuedUserTicketsByAgentCodeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetIssuedTicketsByAgentCode not implemented")
}
...
func _Greeter_GetIssuedTicketsByAgentCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetIssuedUserTicketsByAgentCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).GetIssuedTicketsByAgentCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/games.Greeter/GetIssuedTicketsByAgentCode",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).GetIssuedTicketsByAgentCode(ctx, req.(*GetIssuedUserTicketsByAgentCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetIssuedTicketsByAgentCode",
			Handler:    _Greeter_GetIssuedTicketsByAgentCode_Handler,
		},
		{
